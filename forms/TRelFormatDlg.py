...
"""
UC-23 Relation Template Format  Editor
Module implementing TRelFormatDlg.
...
from forms.Ui_TRelFormatDlg import Ui_TRelFormatDlg
...
#        self.formatDict.setdefault("nodeHeight", 75)
        ...
        self.formatDict.setdefault("lineWidth", 2)
